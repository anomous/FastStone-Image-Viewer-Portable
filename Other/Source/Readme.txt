...
user in an INI file next to FSViewerPortable.exe called FSViewerPortable.ini.
...
copy AppNamePortable.ini from this directory to FSViewerPortable.ini next to
FSViewerPortable.exe. The options in the INI file are as follows:
